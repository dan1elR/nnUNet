...
for i in {0..4}
do
  nnUNetv2_train 012 3d_fullres $i -tr nnUNetTrainer_250epochs --val_best --npz

  #nnUNetv2_train 004 2d $i -tr nnUNetTrainer_100epochs --npz
  nnUNetv2_train 012 2d $i -tr nnUNetTrainer_250epochs --val_best --npz
done

for i in {0..4}
do
  nnUNetv2_train 011 3d_fullres $i -tr nnUNetTrainer_250epochs --val_best --npz

  #nnUNetv2_train 004 2d $i -tr nnUNetTrainer_100epochs --npz
  nnUNetv2_train 011 2d $i -tr nnUNetTrainer_250epochs --val_best --npz
